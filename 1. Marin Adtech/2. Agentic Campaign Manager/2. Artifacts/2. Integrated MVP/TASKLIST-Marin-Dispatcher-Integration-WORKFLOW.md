...
├─────────────────────────────────────────────────────────────────────────┤
│  GABE (Blue)              │  VANES (Red)                                │
│  ├─ 1.1.1: Base Types ⚠️  │  ├─ 1.1.2: Ad Structure Types (waits)      │
│  │   (BLOCKER)            │  ├─ 1.1.4: Type Validators                 │
│  ├─ 1.1.3: Batch Types    │  └─ 1.3.2: Validator Tests                 │
...
graph TB
    ...
    subgraph Phase0["Phase 0: Setup (1 hour) - PARALLEL ✅"]
    ...
    %% Phase 1: Types (PARALLEL after 1.1.1)
    subgraph Phase1["Phase 1: Type Definitions (2-3 hours)"]
        G1_1[GABE: Base Types<br/>1.1.1]
        G1_3[GABE: Batch Types<br/>1.1.3]
        G1_2_1[GABE: Update PlatformCampaignIds<br/>1.2.1]
        V1_2[VANES: Ad Structure Types<br/>1.1.2]
        V1_4[VANES: Type Validators<br/>1.1.4]
        G1_3_1[GABE: Type Tests<br/>1.3.1]
        V1_3_2[VANES: Validator Tests<br/>1.3.2]
    end
    ...
    class G0_1,G0_2,G1_1,G1_3,G1_2_1,G1_3_1,G2_1,G2_2,G2_3,G2C_1,G2C_2,G2C_3,G2C_4,G4_1,G4_2,G4_3,G5_1,G5_2 gabePath
    class V0_1,V0_2,V1_2,V1_4,V1_3_2,V2B_1,V2B_2,V2B_3,V2B_4,V2D_1,V2D_2,V2D_3,V2D_4,V2D_5,V2D_6,V3_1,V3_2,V3_3,V4_1,V4_2,V4_3,V4_4,V5_1,V5_2 vanesPath
...
Phase 1: Types
  ├─ 1.1.1: Base Types ⚠️ (BLOCKER for VANES)
  ├─ 1.1.3: Batch Types
...
Phase 1: Types (PARALLEL after 1.1.1)
  ├─ 1.1.2: Ad Structure Types (waits for 1.1.1)
  ├─ 1.1.4: Type Validators
  └─ 1.3.2: Validator Tests
...
1. **Task 1.1.1 (GABE: Base Types)**
   - Blocks: VANES Task 1.1.2 (Ad Structure Types)
   - Must complete first
...
1. **Phase 1 → Phase 2**
   - GABE hands off base types to VANES
   - Both complete type definitions
